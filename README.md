...
* Cards are divided into **containers**, which is a generic way of dividing a deck into your hand, the opponent's hand, disposed cards, etc. Containers can be nested. The entire set of cards present in the game fall in one container.
